...
- [[STRIDE Threat Modeling]] — six-category threat model; mapped onto OWASP Web Top 10
- [[OWASP LLM Top 10]] — LLM01-LLM10 critical risks for LLM applications
- [[MITRE ATLAS]] — adversary tactics/techniques matrix for AI systems
- [[CompTIA SecAI+]] — AI-as-target vs AI-as-weapon certification framing
- [[Agentic AI Security Principles]] — checklist for safely deploying an autonomous AI agent
- [[Air-Gapped LLM Architecture Pattern]] — offline Java/Ollama coding-assistant reference architecture
- [[NIS2 (EU Cybersecurity Directive)]] — EU cybersecurity law, Polish UKSC implementation
- [[CardKind Pattern (Type-Safe Threat vs Design-Harm Separation)]] — 8-tier ranking of invariant-guarantee strength across 12 languages/platforms
