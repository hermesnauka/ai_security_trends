...
public class OpenApiConfig {
    ...
    @Bean
    public OpenAPI threatViewOpenApi() {
        final String bearerScheme = "bearerAuth";
        return new OpenAPI()
                .info(new Info()
                        .title("ThreatView 2026 API")
                        ...
                        .version("v0.1-phase1")
                        .license(new License().name("Educational use - ThreatView 2026 course project")))
