...
import com.threatview.dto.LoginRequest;
import com.threatview.dto.LoginResponse;
import com.threatview.security.JwtService;
 ...
 * hardcoded in source - see application.yml threatview.admin.*. Replace with
...
public class AuthController {
    ...
    public AuthController(
            ...
            @Value("${threatview.admin.username}") String adminUsername,
            @Value("${threatview.admin.password-hash}") String adminPasswordHash) {
